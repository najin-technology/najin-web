...
export async function generateMetadata({
  ...
  return createPageMetadata({
    ...
    descriptions: {
      ko: "나진테크 25년 노하우의 우레탄 성형, CNC 정밀가공, 합성수지 가공, 금형 제작 제작사례. 현대자동차 프레스공장 우레탄 금형받침대, SK CNC 정밀부품, GM Shanghai 절연재, EV 배터리 인슐레이션 등 대기업 납품 실적 모음.",
      en: "NAJIN TECHNOLOGY project gallery — 25 years of urethane molding, CNC precision machining, synthetic resin processing, mold fabrication. Hyundai press shop urethane mold supports, SK CNC precision parts, GM Shanghai insulation, EV battery insulation, and more enterprise deliveries.",
      zh: "纳进科技制作案例集——25年聚氨酯成型、CNC精密加工、合成树脂加工、模具制作积淀。现代汽车冲压工厂聚氨酯模具支撑、SK CNC精密零件、GM上海绝缘件、电动车电池绝缘等大企业交付实绩。",
    },
  });
}
