                  ...
                  <div className="space-y-2">
                    {(["faq1", "faq2", "faq3"] as const).map((faq) => (
                      <details key={faq} className="group">
                        <summary className="text-xs font-medium text-brand-charcoal/80 cursor-pointer hover:text-brand-blue transition-colors list-none flex items-start gap-2">
                          <span className="text-brand-copper mt-0.5 shrink-0">Q.</span>
                          <span>{t(`${faq}Q`)}</span>
                        </summary>
                        <p className="text-xs text-brand-charcoal/60 mt-1.5 ml-5 leading-relaxed">
                          {t(`${faq}A`)}
                        </p>
                      </details>
                    ))}
