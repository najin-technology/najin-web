...
const fallbackHistory = [
  ...
  { id: "h2", year: 2003, month: 6, description_ko: "㈜한화종합화학 등록 (현 한화임팩트)", description_en: "Registered with Hanwha General Chemical (now Hanwha Impact)" },
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return createPageMetadata({
    ...
    descriptions: {
      ko: "나진테크 회사소개. 2002년 설립된 경남 양산 정밀 가공 제조업체. ISO 9001 인증, 우레탄 금형받침대 특허 보유. 현대자동차, SK, GM Shanghai 등 대기업 납품 25년 노하우. 대표이사 인사말, 연혁, 인증현황, 오시는 길.",
      en: "About NAJIN TECHNOLOGY — precision manufacturer in Yangsan, South Korea since 2002. ISO 9001 certified, urethane mold base patent holder. 25 years supplying Hyundai, SK, GM Shanghai and other major industrial clients. CEO message, history, certifications, location.",
      zh: "纳进科技公司介绍。2002年成立的庆南梁山精密加工制造企业。ISO 9001认证，聚氨酯模具支撑专利持有。25年向现代汽车、SK、GM上海等大企业供货经验。CEO致辞、发展历程、资质认证、交通指南。",
    },
  });
}
