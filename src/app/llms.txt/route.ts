...
> 나진테크는 2002년 12월 경상남도 양산시에 설립된 정밀 가공 전문기업이다. 우레탄 성형, 합성수지 가공, CNC 정밀가공, 금형 제작, EV 부품 가공의 5개 공정을 한 공장에서 일관 처리하며 현대자동차·SK·GM Shanghai·르노삼성·성우하이텍·화신 등 국내외 주요 대기업에 부품을 납품한다.
...
- 현대자동차 (Hyundai Motor) — 변속기라인 가공 부품
- SK — 전지공장 MC블럭 가공
- GM Shanghai — 자동창고용 시트
- 르노삼성, 성우하이텍, 화신 등 자동차·산업 부품사
