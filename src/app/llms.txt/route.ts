...
> 나진테크는 2002년 12월 경상남도 양산시에 설립된 정밀 가공 전문기업이다. 우레탄 성형, 합성수지 가공, CNC 정밀가공, 금형 제작, EV 부품 가공의 5개 공정을 한 공장에서 일관 처리하며 국내외 주요 완성차·배터리·소재 분야 대기업에 부품을 납품한다.
...
- 국내 주요 완성차사 — 변속기라인·프레스공장 가공 부품
- 국내 배터리/에너지 대기업 — 전지공장 MC블럭 가공
- 해외 자동차사 — 자동창고용 시트
- 그 외 국내외 자동차·소재·부품사 다수 (자세한 협업 사례는 거래처 페이지 참고)
